...
export default function AdminApiStatusPage() {
  ...
  const endpoints = [
    ...
    {
      service: "Sarvam AI Saaras v3 STT",
      endpoint: "https://api.sarvam.ai/speech-to-text",
      status: "OPERATIONAL",
      details: "saaras:v3 model for Hindi, Marathi & English speech transcription",
      latency: "310 ms",
    },
    {
      service: "Sarvam AI Bulbul v3 TTS",
      endpoint: "https://api.sarvam.ai/text-to-speech",
      status: "OPERATIONAL",
      details: "bulbul:v3 model for authentic Indian female voice synthesis (Meera speaker)",
      latency: "280 ms",
    },
    {
