...
const PS_SYSTEMS = [
  {
    id: "PS-01",
    name: "Agro-Climatic Intelligence",
    desc: "Zone-aware field profiling across Punjab, Maharashtra, Gujarat, Andhra Pradesh, and Jammu. Geo-tagged soil, crop type, and irrigation registry.",
    icon: "🗺️",
    href: "/fields",
    cta: "Open Field Map",
    badge: "LIVE",
  ...
  {
    id: "PS-02",
    name: "14-Day Plant Stress Forecast",
    desc: "GradientBoostingRegressor ML + Meteoblue NEMSGLOBAL + Syngenta CE Hub APIs. Predicts heat, drought, waterlogging & cold stress with SHAP TreeExplainer attribution.",
    icon: "🌿",
  ...
  {
    id: "PS-03",
    name: "CropFit Biological Advisor",
    desc: "Personalised Syngenta product recommendations (Quantis, Isabion, Amistar Top, Coucal) via decision matrix matching growth stage, stress type, and soil moisture.",
    icon: "🧬",
    href: "/plant-intelligence",
  ...
  {
    id: "PS-04",
    name: "Multilingual Voice & Vision",
    desc: "Google Chirp 3 STT + Gemini 2.0 Flash multimodal AI. Supports 12 Indian languages for voice advisory and leaf disease photo diagnosis.",
    icon: "🎙️",
    href: "/assistant",
    cta: "Try Voice AI",
    badge: "12 LANGUAGES",
  ...
  {
    id: "PS-05",
    name: "Open-Meteo Sensor Network",
    desc: "Real-time air temperature, soil moisture index, wind speed, rainfall, and night heat stress risk alerts via Open-Meteo integration.",
    icon: "🌦️",
    href: "/weather",
    cta: "View Sensors",
  ...
  {
    id: "PS-06",
    name: "Spray Delay Penalty Simulator",
    desc: "Model the financial and yield cost of delaying biological application. Each 24h delay during heat stress reduces bio-efficacy by 12–18%.",
    icon: "🔬",
    href: "/what-if",
    cta: "Run Simulation",
  ...
  {
    id: "PS-07",
    name: "ROBI Yield Attribution Engine",
    desc: "Isolates biostimulant protection effect from weather & soil baselines to prove Return on Biological Investment. 215% verified ROBI on soybean R2 stage.",
    icon: "📊",
    href: "/impact",
    cta: "View ROBI Proof",
    badge: "PS-07 ATTRIBUTION",
    badgeColor: "violet",
  },
];
