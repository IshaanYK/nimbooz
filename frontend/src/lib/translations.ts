...
const EN_DICT: TranslationDict = {
  ...
  heroSubtitle: "Every seed you sow carries your family's hard work. ASSARA protects your crop from heat and guarantees extra profit.",
  ...
  voiceDesc: "Farmers simply speak their questions. ASSARA listens carefully and speaks back clear, practical guidance in an authentic Indian voice.",
  ...
  fieldCommandCenter: "ASSARA FIELD COMMAND CENTER",
  welcomeUser: "Welcome to ASSARA",
  ...
  askAasraTitle: "Ask ASSARA Voice AI & Leaf Scanner",
  ...
  chatWelcome: "Hello! I am ASSARA — your field's intelligent AI companion. Your crop is at R2 flowering stage with elevated night heat. Ask me anything!",
